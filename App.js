...
export default function App() {
  ...
  function verificarGanhador(tabuleiro, linha, coluna){
    ...
    //colunas
    if(tabuleiro[0][coluna] !== '' && tabuleiro[linha][0] !== '' &&tabuleiro[0][coluna] === tabuleiro[1][coluna] && tabuleiro[1][coluna] ===tabuleiro[2][coluna]){
  ...
  function getTelaGanhador(){
    return (
      <View style={styles.container}>
        ...
        {
          ganhador === '' &&
          <Text style={styles.ganhador}>Ouve um empate!</Text>
        }
